<template>
  ...
  <div v-if="clipIndex <= 10" class="w-full flex justify-center items-center mt-6">
    <button class="px-6 py-3 bg-gray-200 md:hover:bg-blue-500 active:bg-blue-500 hover:text-white rounded-full transition-colors duration-300" @click="loadMore">더보기</button>
  </div>
</template>
