...
<template>
  <div class="min-h-full min-w-full">
    ...
    >
      <div class="sm:p-6 sm:pb-0">
        ...
        >
          ...
          >
            ...
            <button
              class="transiton-all rounded-2xl bg-slate-200 px-6 py-3 text-black duration-300 md:hover:bg-slate-300"
      ...
      <div class="flex flex-col items-start justify-between gap-6 p-6 md:flex-row">
        <div>
        ...
        <div class="flex shrink-0 gap-3">
          ...
          <button
            v-if="!fetch && clip.creatorId === me?.twitchUserId || me?.userType && me?.userType !== 'viewer'"
