...
import ExtensionBookmark from './components/ExtensionBookmark.vue';
  ...
  <div class="m-auto max-w-sm p-5">
    ...
    >
      ...
      <a
        ...
        target="_blank"
        class="mt-4 -mb-1 w-full text-center transition-all duration-300 text-slate-600 font-semibold underline underline-offset-4 hover:text-blue-500"
      >방송 보러가기</a>
    </ExCard>
    <ExCard
